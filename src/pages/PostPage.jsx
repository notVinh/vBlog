...
export default function PostPage() {
          ...
          const getAuthor = async () => {
            try {
              ...
              if (res.ok) {
                ...
                setAuthorAvatar(authorData.profilePicture);
              }
            } catch (error) {
              console.log(error);
            }
  ...
  return (
    <main className="p-3 max-w-6xl mx-auto min-h-screen">
      <div className="border-2 flex flex-col border-opacity-40 rounded-xl border-gray-500">
      ...
      <LikedSection
        postId={post._id}
        isLike={post.likes.includes(currentUser && currentUser._id)}
        postItem={post}
      />
